# thirdeye_client.ZzzAllEndpointsZzzApi
...
[**delete_all4**](ZzzAllEndpointsZzzApi.md#delete_all4) | **DELETE** /api/alert-templates/all | 
...
[**get1**](ZzzAllEndpointsZzzApi.md#get1) | **GET** /api/data-sources/name/{name} | 
[**get10**](ZzzAllEndpointsZzzApi.md#get10) | **GET** /api/alert-templates/{id} | 
[**get11**](ZzzAllEndpointsZzzApi.md#get11) | **GET** /api/enumeration-items/name/{name} | 
[**get12**](ZzzAllEndpointsZzzApi.md#get12) | **GET** /api/enumeration-items/{id} | 
[**get13**](ZzzAllEndpointsZzzApi.md#get13) | **GET** /api/subscription-groups/name/{name} | 
[**get14**](ZzzAllEndpointsZzzApi.md#get14) | **GET** /api/subscription-groups/{id} | 
[**get15**](ZzzAllEndpointsZzzApi.md#get15) | **GET** /api/anomalies/name/{name} | 
[**get16**](ZzzAllEndpointsZzzApi.md#get16) | **GET** /api/anomalies/{id} | 
[**get17**](ZzzAllEndpointsZzzApi.md#get17) | **GET** /api/rca/investigations/name/{name} | 
[**get18**](ZzzAllEndpointsZzzApi.md#get18) | **GET** /api/rca/investigations/{id} | 
[**get19**](ZzzAllEndpointsZzzApi.md#get19) | **GET** /api/events/name/{name} | 
[**get2**](ZzzAllEndpointsZzzApi.md#get2) | **GET** /api/data-sources/{id} | 
[**get20**](ZzzAllEndpointsZzzApi.md#get20) | **GET** /api/events/{id} | 
[**get21**](ZzzAllEndpointsZzzApi.md#get21) | **GET** /api/tasks/name/{name} | 
[**get22**](ZzzAllEndpointsZzzApi.md#get22) | **GET** /api/tasks/{id} | 
[**get23**](ZzzAllEndpointsZzzApi.md#get23) | **GET** /api/ui/config | 
[**get3**](ZzzAllEndpointsZzzApi.md#get3) | **GET** /api/datasets/name/{name} | 
[**get4**](ZzzAllEndpointsZzzApi.md#get4) | **GET** /api/datasets/{id} | 
[**get5**](ZzzAllEndpointsZzzApi.md#get5) | **GET** /api/metrics/name/{name} | 
[**get6**](ZzzAllEndpointsZzzApi.md#get6) | **GET** /api/metrics/{id} | 
[**get7**](ZzzAllEndpointsZzzApi.md#get7) | **GET** /api/alerts/name/{name} | 
[**get8**](ZzzAllEndpointsZzzApi.md#get8) | **GET** /api/alerts/{id} | 
[**get9**](ZzzAllEndpointsZzzApi.md#get9) | **GET** /api/alert-templates/name/{name} | 
...
[**get_analytics_payload**](ZzzAllEndpointsZzzApi.md#get_analytics_payload) | **GET** /api/app-analytics | 
...
[**get_insights**](ZzzAllEndpointsZzzApi.md#get_insights) | **POST** /api/alerts/insights | 
[**get_insights1**](ZzzAllEndpointsZzzApi.md#get_insights1) | **GET** /api/alerts/{id}/insights | 
...
[**load_holidays**](ZzzAllEndpointsZzzApi.md#load_holidays) | **POST** /api/events/holidays/load | 
[**load_holidays1**](ZzzAllEndpointsZzzApi.md#load_holidays1) | **POST** /api/events/create-from-anomaly | 
...
# create an instance of the API class
api_instance = thirdeye_client.ZzzAllEndpointsZzzApi(thirdeye_client.ApiClient(configuration))
body = [thirdeye_client.DataSourceApi()] # list[DataSourceApi] |  (optional)
...
------------- | ------------- | ------------- | -------------
 **body** | [**list[DataSourceApi]**](DataSourceApi.md)|  | [optional] 
...
# create an instance of the API class
api_instance = thirdeye_client.ZzzAllEndpointsZzzApi(thirdeye_client.ApiClient(configuration))
body = [thirdeye_client.MetricApi()] # list[MetricApi] |  (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**list[MetricApi]**](MetricApi.md)|  | [optional] 
...
# create an instance of the API class
api_instance = thirdeye_client.ZzzAllEndpointsZzzApi(thirdeye_client.ApiClient(configuration))
body = [thirdeye_client.AnomalyApi()] # list[AnomalyApi] |  (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**list[AnomalyApi]**](AnomalyApi.md)|  | [optional] 
...
# create an instance of the API class
api_instance = thirdeye_client.ZzzAllEndpointsZzzApi(thirdeye_client.ApiClient(configuration))
body = [thirdeye_client.RcaInvestigationApi()] # list[RcaInvestigationApi] |  (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**list[RcaInvestigationApi]**](RcaInvestigationApi.md)|  | [optional] 
...
# create an instance of the API class
api_instance = thirdeye_client.ZzzAllEndpointsZzzApi(thirdeye_client.ApiClient(configuration))
body = thirdeye_client.CohortComputationApi() # CohortComputationApi |  (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**CohortComputationApi**](CohortComputationApi.md)|  | [optional] 
...
try:
    api_instance.get16(id)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get16: %s\n" % e)
```
...
try:
    api_instance.get17(name)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get17: %s\n" % e)
```
...
try:
    api_instance.get18(id)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get18: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get19: %s\n" % e)
```
...
try:
    api_instance.get2(id)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get2: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get20: %s\n" % e)
```
...
try:
    api_instance.get21(name)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get21: %s\n" % e)
```
...
try:
    api_instance.get22(id)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get22: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get23: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get3: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get4: %s\n" % e)
```
...
try:
    api_instance.get5(name)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get5: %s\n" % e)
```
...
try:
    api_instance.get6(id)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->get6: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get7: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get8: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get9: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all1: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all10: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all2: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all3: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all4: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all5: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all6: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all7: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all8: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_all9: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_analytics: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_analytics_payload: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_anomalies_events: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_anomaly_heatmap: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_calendar_events: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_datasets: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_entity: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_entity_info: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_insights: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_insights1: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_package_info: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_raw_entity: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_tables: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->get_version: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->home: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->list_entities: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->load_holidays: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->load_holidays1: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->load_recommended_templates: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->login: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->logout: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->notify: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->offboard_all: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->onboard_all: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->onboard_dataset: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->ping: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->post: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->purge: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->reset: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->reset1: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->run_task: %s\n" % e)
```
...
api_instance = thirdeye_client.ZzzAllEndpointsZzzApi(thirdeye_client.ApiClient(configuration))
id = 789 # int | 
body = thirdeye_client.AnomalyFeedbackApi() # AnomalyFeedbackApi |  (optional)

try:
    api_instance.set_feedback(id, body=body)
except ApiException as e:
    print("Exception when calling ZzzAllEndpointsZzzApi->set_feedback: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **int**|  | 
 **body** | [**AnomalyFeedbackApi**](AnomalyFeedbackApi.md)|  | [optional] 
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->trigger_webhook: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->validate: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->validate_multiple: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->webhook_dummy: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling ZzzAllEndpointsZzzApi->worker_id: %s\n" % e)
```
